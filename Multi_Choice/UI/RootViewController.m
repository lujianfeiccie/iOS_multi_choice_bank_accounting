...
- (void)viewDidLoad
{
    ...
    model = [[ModelData alloc]init];
    model.m_text = @"2010年7月真题";
    model.m_value = @"2010_07";
    [m_datalist addObject:model];

    model = [[ModelData alloc]init];
    model.m_text = @"2009年7月真题";
    model.m_value = @"2009_07";
    [m_datalist addObject:model];

    model = [[ModelData alloc]init];
    model.m_text = @"2008年7月真题";
    model.m_value = @"2008_07";
    [m_datalist addObject:model];

    model = [[ModelData alloc]init];
    model.m_text = @"2007年7月真题";
    model.m_value = @"2007_07";
    [m_datalist addObject:model];
...
-(void) threadSearch :(NSString*) keywords
{
    ...
    NSArray* mutli_short_answer_filename = [NSArray arrayWithObjects:
                                            ...
                                            @"2010_07_short_answer",
                                            @"2009_07_short_answer",
                                            @"2008_07_short_answer",
                                            @"2007_07_short_answer",
                                            nil];
